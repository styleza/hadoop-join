...
public class MultipleFiles extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(c, "bloomfilter join ");
        job.addCacheFile(p2.toUri());
        job.setJarByClass(MultipleFiles.class);

        MultipleInputs.addInputPath(job, p1,TextInputFormat.class, FileMap.class);
        MultipleInputs.addInputPath(job, p2,TextInputFormat.class, MapBloom.class);
